...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :url "/post/9/a-estrada-do-machine-learning"
...
** DONE Diferença entre permuta, combinação e arranjo
:PROPERTIES:
:EXPORT_FILE_NAME: diferenca-entre-permuta-combinacao-e-arranjo
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :url "post/8/diferenca-entre-permuta-combinacao-e-arranjo"
:EXPORT_DATE: <2018-02-09 Fri> 
:END:
...
Fórmula da Permuta: \(C = {n!}, \text{n = número de elementos}\)

Seguindo o exemplo da palavra SOL, a fórmula aplicada seria a
seguinte:

\[C = {3!} = 6 \text{ possibilidades.}\]
...
\[C = {15!} = \text{1 trilhão 307 bilhões 674 milhões e 368 mil possibilidades.}\]
...
\[C = {n! \over (n-p)!}\], onde \( n = \text{número total de elementos}, p = \text{restrição}\)
...
\[C = {30! \over (30-3)! } = 24360 \text{ possibilidades.}\]
...
\[C = {4! \over 2! * (4-2)!} = 6 \text{ grupos diferentes.}\]

\[n = 4\] sobreviventes

\[p = 2\text{ pessoas por grupo}\]
